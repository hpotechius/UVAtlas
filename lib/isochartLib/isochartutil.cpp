...
namespace
{
    ...
    static void CalculateSegmentsIntersection(
        const /*XMFLOAT2&*/ glm::vec2& p0, const /*XMFLOAT2&*/ glm::vec2& p1,	// Two ports of segment 1
        const /*XMFLOAT2&*/ glm::vec2& p3, const /*XMFLOAT2&*/ glm::vec2& p4,	// Two ports of segment 2
        /*XMFLOAT2&*/ glm::vec2& intersection,
        float& fT,
        float& fS)
    {
        float x0, x1, x3, x4;
...
bool Isochart::IsochartIsSegmentsIntersect(
    ...
    /*XMFLOAT2**/ glm::vec2* pIntersection)
{
    /*XMFLOAT2*/ glm::vec2 intersection;
    float fS, fT;

    CalculateSegmentsIntersection(p0, p1, p3, p4, intersection, fS, fT);
    ...
    float* fRotMatrix)
{
    ...
    float IMT[IMT_DIM];
    GetIMTOnCanonicalFace(pMT, fFace3DArea, IMT);
