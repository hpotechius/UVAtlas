...
namespace Isochart
{
    ...
    public:
        ...
        /*XMFLOAT3**/ glm::vec3* pVertPosition; 	//Internal vertex position, (by scale original position in pVertexArray) 

        /*XMFLOAT3**/ glm::vec3* pFaceNormalArray; // Normal of each face

        /*XMFLOAT2**/ glm::vec2* pFaceCanonicalUVCoordinate; // UV coordinates of each face after canonical transform
        /*XMFLOAT3**/ glm::vec3* pFaceCanonicalParamAxis;	//The X-axis and Y-axix used to tranform a 3D point on a  											
