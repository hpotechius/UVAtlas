...
namespace Isochart
{
    ...
    struct ISOCHARTVERTEX
    {
        ...
        /*DirectX::XMFLOAT2*/ glm::vec2 uv;           //UV coordinate in texture map
    ...
    private:
        ...
        float CalFaceSquraedStretch(
            ...
            const /*DirectX::XMFLOAT2&*/ glm::vec2 &v0,
            const /*DirectX::XMFLOAT2&*/ glm::vec2 &v1,
            const /*DirectX::XMFLOAT2&*/ glm::vec2 &v2,
            const float fScale,
            float& f2D,
        ...
        float GetFaceAreaAroundVertex(
            ...
            /*DirectX::XMFLOAT2&*/ glm::vec2 &newUV) const;
        ...
        void LimitVertexToBoundingBox(
            const /*DirectX::XMFLOAT2&*/ glm::vec2 &end,
            const /*DirectX::XMFLOAT2&*/ glm::vec2 &minBound,
            const /*DirectX::XMFLOAT2&*/ glm::vec2 &maxBound,
            /*DirectX::XMFLOAT2&*/ glm::vec2 &result);

        void UpdateOptimizeResult(
            CHARTOPTIMIZEINFO& optimizeInfo,
            ISOCHARTVERTEX* pOptimizeVertex,
            /*DirectX::XMFLOAT2&*/ glm::vec2 &vertexNewCoordinate,
        ...
        void TryAdjustVertexParamStretch(
            ...
            bool bOptSignal,
            float fStretchScale,
            /*DirectX::XMFLOAT2&*/ glm::vec2 &newUV,
            float& fStretch,
        ...
        static HRESULT MergeAdjacentChart(
            ...
            bool* pbMergeFlag,
            /*DirectX::XMFLOAT3**/ glm::vec3 *pChartNormal,
            bool& bMerged);
        ...
        void CalculateAveragNormal(
            /*DirectX::XMFLOAT3**/ glm::vec3 *pVector) const;
