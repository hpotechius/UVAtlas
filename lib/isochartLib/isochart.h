...
namespace Isochart
{
    ...
    typedef std::function<HRESULT (float percentComplete)> LPISOCHARTCALLBACK;
    typedef std::function<HRESULT (/*const XMFLOAT2 **/glm::vec2* uv, size_t primitiveID, size_t signalDimension, void* userData, float* signalOut)> LPIMTSIGNALCALLBACK;
