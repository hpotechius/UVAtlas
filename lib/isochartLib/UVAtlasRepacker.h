...
namespace IsochartRepacker
{
    ...
    struct _EDGE {
        /*DirectX::XMFLOAT2*/ glm::vec2 p1;
        /*DirectX::XMFLOAT2*/ glm::vec2 p2;
        /*DirectX::XMFLOAT2*/ glm::vec2 minP;
        /*DirectX::XMFLOAT2*/ glm::vec2 maxP;
        _EDGE() = default;
        _EDGE(const /*DirectX::XMFLOAT2&*/ glm::vec2&_p1, const /*DirectX::XMFLOAT2&*/ glm::vec2& _p2) : p1(_p1), p2(_p2) {
    ...
    struct _PositionInfo {
    	/*DirectX::XMFLOAT2*/ glm::vec2 basePoint;    // record one specific point in a corner point of tessellation grids
                                        // we can get the transformation matrix through this point
    	/*DirectX::XMFLOAT2*/ glm::vec2 minPoint;     // top left corner of bounding box
    	/*DirectX::XMFLOAT2*/ glm::vec2 maxPoint;     // bottom right corner of bounding box
        int numX;                       // number of grids in X direction
        int numY;                       // number of grids in Y direction
        /*DirectX::XMFLOAT2*/ glm::vec2 adjustLen;    // make the chart in a best place
    ...
    private:
        ...
        HRESULT Initialize();
        void ComputeBoundingBox(std::vector</*DirectX::XMFLOAT2*/ glm::vec2>& Vec, /*DirectX::XMFLOAT2**/ glm::vec2* minV, /*DirectX::XMFLOAT2**/ glm::vec2* maxV);
    ...
    private:
        ...
        std::vector</*DirectX::XMFLOAT4X4*/ glm::mat4>    m_ResultMatrix;     // result matrix of each chart
